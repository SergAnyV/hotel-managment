...
public class BotServiceImpl implements BotService {
    ...
    private void sendWelcome(long chatId, String username) {
        ...
        String text = "Добро пожаловать, " + username + "! Выберите из раздела меню, интересующую вас информацию." + "\n"
                + "Это демонстрационный бот, вы можете попробовать разные варианты в том числе и войти под своим логином" +
                " и паролем, для прохождения авторизации вам нужно будет пройти по ссылке в письме которое мы отправил ," +
